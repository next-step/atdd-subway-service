...
class AuthAcceptanceTest extends AcceptanceTest {
    ...
    public static final String CORRECT_PASSWORD = "jordy";
    public static final String WRONG_PASSWORD = "jordy*";
    public static final Age AGE = new Age(29);
    ...
    Stream<DynamicTest> manageAuth() {
        return Stream.of(
                dynamicTest("회원 생성 요청 및 성공 확인", 회원_생성_요청_및_성공_확인(EMAIL, CORRECT_PASSWORD, AGE)),
