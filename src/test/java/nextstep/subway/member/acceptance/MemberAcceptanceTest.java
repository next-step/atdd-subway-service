...
import static nextstep.subway.member.acceptance.MemberTestApi.*;
import static nextstep.subway.member.acceptance.MyMemberTestApi.*;
import static nextstep.subway.member.acceptance.memberAcceptanceValidation.*;
...
public class MemberAcceptanceTest extends AcceptanceTest {
    ...
    void manageMyInfo() {
        ...
        // then
        내_정보_조회_요청됨(findResponse, EMAIL, AGE);
