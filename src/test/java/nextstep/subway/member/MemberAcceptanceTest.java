...
public class MemberAcceptanceTest extends AcceptanceTest {
    ...
    public static final String MEMBERS_ME_BASE_URL = "/members/me";
    ...
    void manageMyInfo() {
        ...
        // when
        ExtractableResponse<Response> updateResponse = 나의_정보_수정_요청(accessToken, NEW_EMAIL, NEW_PASSWORD, NEW_AGE);
        // then
        회원_정보_수정됨(updateResponse);
    ...
    public static ExtractableResponse<Response> 나의_정보_삭제_요청(String token) {
        return RestAssured
                .given().log().all()
                .header(HttpHeaders.AUTHORIZATION, makeAccessToken(token))
                .when().delete(MEMBERS_ME_BASE_URL)
                .then().log().all()
                .extract();
    }
