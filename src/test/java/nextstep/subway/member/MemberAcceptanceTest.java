...
public class MemberAcceptanceTest extends AcceptanceTest {
     ...
     *
     *    Scenario: 내 정보 관리
     *     When 나의 토큰을 사용하여 정보 조회 요청
     *     Then 내 정보 조회됨
     *     When 나의 토큰을 사용하여 정보 수정 요청
     *     Then 내 정보 수정됨
     *     When 나의 토큰을 사용하여 정보 삭제 요청
     *     Then 내 정보 삭제됨
     */
    ...
    void manageMyInfo() {
        ...
        //When
        ExtractableResponse<Response> findResponse = 내정보_조회_요청(token);
        //Then
        내정보_조회됨(findResponse);

        //When
        MemberRequest newMemberRequest = new MemberRequest(NEW_EMAIL, NEW_PASSWORD, NEW_AGE);
        ExtractableResponse<Response> updateResponse = 내정보_수정_요청(token, newMemberRequest);
        //Then
