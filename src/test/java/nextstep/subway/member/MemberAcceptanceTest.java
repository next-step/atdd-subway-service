...
public class MemberAcceptanceTest extends AcceptanceTest {
	...
	void manageMyInfo() {
		...
		String accessToken = AuthAcceptanceTest.접근권한_토큰값을_가져온다(EMAIL, PASSWORD);
		...
		// when
		ExtractableResponse<Response> updateResponse = 나의_정보_수정_요청(accessToken, NEW_EMAIL,
			  NEW_PASSWORD, NEW_AGE);
		// then
		회원_정보_수정됨(updateResponse);
	...
	private ExtractableResponse<Response> 나의_정보_수정_요청(String accessToken, String email,
