...
public class MemberAcceptanceTest extends AcceptanceTest {
    ...
    void manageMyInfo() {
        ...
        ExtractableResponse<Response> response2 = 내_정보_수정_요청(tokenResponse);
        내_정보_수정됨(response2);

        ExtractableResponse<Response> response3 =내_정보_삭제_요청(tokenResponse);
        내_정보_삭제됨(response3);
    }
    ...
    private ExtractableResponse<Response> 내_정보_수정_요청(TokenResponse tokenResponse) {
