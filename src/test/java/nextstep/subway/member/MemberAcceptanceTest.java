...
public class MemberAcceptanceTest extends AcceptanceTest {
	...
	void manageMyInfo() {
		...
		//when
		ExtractableResponse<Response> getResponse = 내_정보_조회_요청(tokenResponse.getAccessToken());
		//then
		assertThat(getResponse.jsonPath().getObject(".", MemberResponse.class).getEmail()).isEqualTo(MemberAcceptanceTest.EMAIL);

		//when
		MemberRequest memberRequest = new MemberRequest(MemberAcceptanceTest.EMAIL, MemberAcceptanceTest.PASSWORD, 100);
		ExtractableResponse<Response> putResponse = 내_정보_수정_요청(tokenResponse.getAccessToken(), memberRequest);

		//then
		ExtractableResponse<Response> responseAfterUpdate = 내_정보_조회_요청(tokenResponse.getAccessToken());
		MemberResponse resultAfterUpdate = responseAfterUpdate.as(MemberResponse.class);
		assertThat(putResponse.statusCode()).isEqualTo(HttpStatus.OK.value());
		assertThat(resultAfterUpdate.getAge()).isEqualTo(memberRequest.getAge());
