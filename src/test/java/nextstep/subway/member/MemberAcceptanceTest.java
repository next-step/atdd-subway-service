...
public class MemberAcceptanceTest extends AcceptanceTest {
    ...
    void manageMyInfo() {
        ...
        response = AuthAcceptanceTest.로그인_요청(EMAIL, PASSWORD);
        TokenResponse tokenResponse = response.jsonPath().getObject(".", TokenResponse.class);

        // when
        response = 내_정보_조회_요청(tokenResponse);
        // then
        내_정보_조회됨(response, EMAIL, AGE);

        // when
        response = 내_정보_수정_요청(tokenResponse, NEW_EMAIL, NEW_PASSWORD, NEW_AGE);
        // then
        내_정보_수정됨(response);
    ...
    public static ExtractableResponse<Response> 내_정보_수정_요청(TokenResponse tokenResponse, String newEmail, String newPassword, int newAge) {
