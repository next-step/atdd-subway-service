...
public class MemberAcceptanceTest extends AcceptanceTest {
    ...
    void manageMyInfo() {
        ...
        // then
        로그인_요청_성공(tokenResponse);

        // when
        ExtractableResponse<Response> findResponse = 토큰값으로_회원_정보_요청(tokenResponse);
        // then
        회원_정보_조회됨(findResponse, EMAIL, AGE);

        // when
        ExtractableResponse<Response> updateResponse = 토큰값으로_회원_정보_수정_요청(tokenResponse, NEW_EMAIL, NEW_PASSWORD, NEW_AGE);
        // then
        회원_정보_수정됨(updateResponse);
    ...
    private ExtractableResponse<Response> 토큰값으로_회원_삭제_요청(ExtractableResponse<Response> response) {
    ...
    private ExtractableResponse<Response> 토큰값으로_회원_정보_수정_요청(ExtractableResponse<Response> response, String email, String password, int age) {
        TokenResponse tokenResponse = response.as(TokenResponse.class);
        MemberRequest memberRequest = new MemberRequest(email, password, age);
