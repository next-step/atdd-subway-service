...
public class MemberAcceptanceTest extends AcceptanceTest {
    ...
    void manageMyInfo() {
        ...
        // 내 정보 수정
        // when
        ExtractableResponse<Response> myInfoUpdateResponse = 나의_정보_수정_요청(accessToken, NEW_EMAIL, NEW_PASSWORD, NEW_AGE);
        // then
        나의_정보_수정됨(myInfoUpdateResponse);

        // 내 정보 삭제
        // when
        ExtractableResponse<Response> myInfoDeleteResponse = 나의_정보_삭제_요청(accessToken);
        // then
        나의_정보_삭제됨(myInfoDeleteResponse);
    }
