...
public class MemberAcceptanceTest extends AcceptanceTest {
	...
	void manageMyInfo() {
		...
		TokenResponse 토큰 = AuthAcceptanceTest.로그인됨(EMAIL, PASSWORD);

		// when
		ExtractableResponse<Response> findResponse = 내_정보_조회_요청(토큰);
		// then
		내_정보_응답됨(findResponse, EMAIL);

		// when
		ExtractableResponse<Response> updateResponse = 내_정보_수정_요청(토큰, NEW_EMAIL, NEW_PASSWORD, NEW_AGE);
		// then
		회원_정보_수정됨(updateResponse);
	...
	private static ExtractableResponse<Response> 내_정보_수정_요청(
		TokenResponse tokenResponse, String newEmail, String newPassword, int newAge) {
	...
	public static ExtractableResponse<Response> 회원_등록됨(String email, String password) {
