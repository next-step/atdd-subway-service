...
public class MemberAcceptanceTest extends AcceptanceTest {
    ...
    void manageMyInfo() {
        ...
        // given
        String token = AuthAcceptanceTest.회원_토큰_요청(EMAIL, PASSWORD).jsonPath()
        ...
        // when
        ExtractableResponse<Response> updateResponse = 내_정보_수정_요청(token, "updateEmail@gmail.com", PASSWORD, AGE);
        // then
        회원_정보_수정됨(updateResponse);
