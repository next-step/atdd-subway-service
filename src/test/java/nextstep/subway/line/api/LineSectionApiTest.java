...
public class LineSectionApiTest extends AcceptanceTest {
    ...
    void addLineSection1() {
        ...
        지하철_노선에_지하철역_순서_정렬됨(response, 강남역, 양재역, 광교역);
    }
    ...
    void addLineSection2() {
        ...
        ExtractableResponse<Response> response = LineAcceptanceTest.지하철_노선_조회_요청(신분당선);
        지하철_노선에_지하철역_등록됨(response);
        지하철_노선에_지하철역_순서_정렬됨(response, 정자역, 강남역, 양재역, 광교역);
    }
    ...
    void removeLineSection1() {
        ...
        ExtractableResponse<Response> response = LineAcceptanceTest.지하철_노선_조회_요청(신분당선);
        지하철_노선에_지하철역_순서_정렬됨(response, 강남역, 정자역, 광교역);
    }
