...
public class LineSectionTestAcceptanceTest extends AcceptanceTest {
    ...
    @DisplayName("지하철 구간 관리 - 등록, 조회, 삭제")
    @Test
    void acceptanceTest() {
        //when
        ...
        지하철_노선에_지하철역_순서_정렬됨(addResponse, Arrays.asList(정자역, 강남역, 양재역, 광교역));
        ...
        ExtractableResponse<Response> deleteResponse = LineAcceptanceTest.지하철_노선_조회_요청(신분당선);
        지하철_노선에_지하철역_순서_정렬됨(deleteResponse, Arrays.asList(정자역, 강남역, 광교역));
    }
