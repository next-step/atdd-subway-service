...
public class LineSectionAcceptanceTest extends AcceptanceTest {
    ...
    void lineSectionManagementScenario() {
        ...
        ExtractableResponse<Response> 노선에_역_목록 = LineAcceptanceTest.지하철_노선_조회_요청(신분당선);

        // then 등록한 지하철 구간이 반영된 역 목록이 조회됨
        지하철_노선에_지하철역_순서_정렬됨(노선에_역_목록, Arrays.asList(강남역, 양재역, 광교역));
        ...
        // when 지하철 노선에 등록된 역 목록 조회 요청
        노선에_역_목록 = LineAcceptanceTest.지하철_노선_조회_요청(신분당선);

        // then 삭제한 지하철 구간이 반영된 역 목록이 조회됨
        지하철_노선에_지하철역_순서_정렬됨(노선에_역_목록, Arrays.asList(강남역, 광교역));
    }
