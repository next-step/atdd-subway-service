...
public class LineSectionAcceptanceTest extends AcceptanceTest {
    ...
    @DisplayName("지하철 구간 관리 기능 통합 테스트")
    @Test
    void manageSections() {
        // when
        ...
        ExtractableResponse<Response> createResultResponse = LineAcceptanceTest.지하철_노선_조회_요청(신분당선);
        지하철_노선에_지하철역_순서_정렬됨(createResultResponse, Arrays.asList(강남역, 양재역, 광교역));
        ...
        지하철_노선에_지하철역_순서_정렬됨(removeResultResponse, Arrays.asList(강남역, 광교역));
    }
