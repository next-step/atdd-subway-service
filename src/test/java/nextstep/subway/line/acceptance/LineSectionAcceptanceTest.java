...
import static nextstep.subway.line.acceptance.LineSectionTestUtils.*;
...
public class LineSectionAcceptanceTest extends AcceptanceTest {
    ...
    public void setUp() {
        ...
        정자역 = StationTestUtils.지하철역_등록되어_있음("정자역").as(StationResponse.class);
        광교역 = StationTestUtils.지하철역_등록되어_있음("광교역").as(StationResponse.class);

        LineRequest lineRequest = new LineRequest("신분당선", "bg-red-600", 강남역.getId(), 광교역.getId(), 10);
        신분당선 = LineTestUtils.지하철_노선_등록되어_있음(lineRequest).as(LineResponse.class);
    }
    ...
    void addLineSection() {
        ...
        // then
        ExtractableResponse<Response> response = LineTestUtils.지하철_노선_조회_요청(신분당선);
