...
public class LineSectionAcceptanceTest extends AcceptanceTest {
    ...
    void addLineSection() {
        ...
        // then
        ExtractableResponse<Response> 조회된_신분당선_역_목록 = 지하철_노선_조회_요청(신분당선);
        지하철_노선에_지하철역_등록됨(조회된_신분당선_역_목록);
        지하철_노선에_지하철역_순서_정렬됨(조회된_신분당선_역_목록, Arrays.asList(강남역, 양재역, 광교역));
    }
    ...
    void addLineSection2() {
        ...
        ExtractableResponse<Response> 조회된_신분당선_역_목록 = 지하철_노선_조회_요청(신분당선);
        지하철_노선에_지하철역_등록됨(조회된_신분당선_역_목록);
        지하철_노선에_지하철역_순서_정렬됨(조회된_신분당선_역_목록, Arrays.asList(정자역, 강남역, 양재역, 광교역));
    }
    ...
    void addLineSectionWithSameStation() {
        // when
        ExtractableResponse<Response> 강남역_광교역_중복_등록_요청된_신분당선 = 지하철_노선에_지하철역_등록_요청(신분당선, 강남역, 광교역, 3);

        // then
        지하철_노선에_지하철역_등록_실패됨(강남역_광교역_중복_등록_요청된_신분당선);
    }
    ...
    void addLineSectionWithNoStation() {
        // when
        ExtractableResponse<Response> 정자역_양재역_등록_실패된_신분당선 = 지하철_노선에_지하철역_등록_요청(신분당선, 정자역, 양재역, 3);

        // then
        지하철_노선에_지하철역_등록_실패됨(정자역_양재역_등록_실패된_신분당선);
    }
    ...
    void removeLineSection1() {
        ...
        // when
        ExtractableResponse<Response> 양재역_제외된_신분당선 = 지하철_노선에_지하철역_제외_요청(신분당선, 양재역);

        // then
        지하철_노선에_지하철역_제외됨(양재역_제외된_신분당선);
    ...
    void removeLineSection2() {
        // when
        ExtractableResponse<Response> 강남역_제외_실패된_신분당선 = 지하철_노선에_지하철역_제외_요청(신분당선, 강남역);

        // then
        지하철_노선에_지하철역_제외_실패됨(강남역_제외_실패된_신분당선);
    }
