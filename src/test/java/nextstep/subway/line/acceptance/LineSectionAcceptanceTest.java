...
import static nextstep.subway.line.acceptance.LineAcceptanceTest.노선_요청_객체_생성;
...
public class LineSectionAcceptanceTest extends AcceptanceTest {
    ...
    public void setUp() {
        ...
        LineRequest lineRequest = 노선_요청_객체_생성("신분당선", "bg-red-600", 강남역.getId(), 광교역.getId(), 10, 500);
