...
public class LineSectionAcceptanceTest extends AcceptanceTest {
    ...
    @Test
    void 지하철_구간_관리_시나리오_흐름_검증() {
        ExtractableResponse<Response> response;
        // When 지하철 구간 등록 요청
        response = 지하철_노선에_지하철역_등록_요청(신분당선, 강남역, 양재역, 3);
        // Then 지하철 구간 등록됨
    ...
    void addLineSection() {
        ...
        // then
        지하철_노선에_지하철역_등록됨(response);
        지하철_노선에_지하철역_순서_정렬됨(LineAcceptanceTest.지하철_노선_조회_요청(신분당선), Arrays.asList(강남역, 양재역, 광교역));
    }
    ...
    void addLineSection2() {
        ...
        // then
        지하철_노선에_지하철역_등록됨(response);
        지하철_노선에_지하철역_순서_정렬됨(LineAcceptanceTest.지하철_노선_조회_요청(신분당선), Arrays.asList(정자역, 강남역, 양재역, 광교역));
    }
