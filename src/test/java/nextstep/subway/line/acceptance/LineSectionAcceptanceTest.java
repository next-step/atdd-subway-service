...
public class LineSectionAcceptanceTest extends AcceptanceTest {
    ...
    void addLineSection2() {
        // when
        지하철_구간_등록_요청(신분당선, 강남역, 양재역, 2);
        지하철_구간_등록_요청(신분당선, 정자역, 강남역, 5);
    ...
    void addLineSectionWithSameStation() {
        // when
        ExtractableResponse<Response> response = 지하철_구간_등록_요청(신분당선, 강남역, 광교역, 3);
    ...
    void addLineSectionWithNoStation() {
        // when
        ExtractableResponse<Response> response = 지하철_구간_등록_요청(신분당선, 정자역, 양재역, 3);
    ...
    void removeLineSection2() {
        // when
        ExtractableResponse<Response> removeResponse = 지하철_구간_삭제_요청(신분당선, 강남역);

        // then
        지하철_노선에_지하철역_제외_실패됨(removeResponse);
    }

    public static ExtractableResponse<Response> 지하철_구간_등록_요청(LineResponse line,
    ...
    public static void 지하철_노선에_지하철역_등록되어_있음(LineResponse line, StationResponse upStation, StationResponse downStation, int distance) {
        지하철_구간_등록_요청(line, upStation, downStation, distance);
    }
}
