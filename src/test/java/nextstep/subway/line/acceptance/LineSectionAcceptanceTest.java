...
public class LineSectionAcceptanceTest extends AcceptanceTest {
	...
	void scenario1() {
		...
		// When
		ExtractableResponse<Response> findResponse = LineAcceptanceTest.지하철_노선_조회_요청(신분당선);
		...
		// When
		ExtractableResponse<Response> find2Response = LineAcceptanceTest.지하철_노선_조회_요청(신분당선);

		// Then
		지하철_노선에_지하철역_순서_정렬됨(find2Response, Arrays.asList(강남역, 광교역));
	}
