...
import static nextstep.subway.line.acceptance.LineAcceptanceTestMethod.지하철_노선_조회_요청;
import static nextstep.subway.line.acceptance.LineSectionAcceptanceTestMethod.지하철_노선에_지하철역_등록_실패됨;
import static nextstep.subway.line.acceptance.LineSectionAcceptanceTestMethod.지하철_노선에_지하철역_등록_요청;
import static nextstep.subway.line.acceptance.LineSectionAcceptanceTestMethod.지하철_노선에_지하철역_등록됨;
import static nextstep.subway.line.acceptance.LineSectionAcceptanceTestMethod.지하철_노선에_지하철역_순서_정렬됨;
import static nextstep.subway.line.acceptance.LineSectionAcceptanceTestMethod.지하철_노선에_지하철역_제외_실패됨;
import static nextstep.subway.line.acceptance.LineSectionAcceptanceTestMethod.지하철_노선에_지하철역_제외_요청;
import static nextstep.subway.line.acceptance.LineSectionAcceptanceTestMethod.지하철_노선에_지하철역_제외됨;
...
class LineSectionAcceptanceTest extends AcceptanceTest {
     ...
     */
    @DisplayName("지하철 구간 관리에 대한 통합 인수테스트 - 등록/조회/삭제")
    @Test
    void lineSectionManageTest() {
        // when
        지하철_노선에_지하철역_등록_요청(신분당선, 강남역, 양재역, 3);
        ...
        // when & then
        ExtractableResponse<Response> finalResponse = 지하철_노선_조회_요청(신분당선);
        지하철_노선에_지하철역_순서_정렬됨(finalResponse, Arrays.asList(강남역, 광교역));
    }
}
