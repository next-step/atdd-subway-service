...
public class LineSectionAcceptanceTest extends AcceptanceTest {
    ...
    void manageLineSection() {
        ...
        ExtractableResponse<Response> foundLineStationsResponse = LineAcceptanceTest.지하철_노선_조회_요청(신분당선);

        // Then 등록한 지하철 구간이 반영된 역 목록이 조회됨
        지하철_노선에_지하철역_순서_정렬됨(foundLineStationsResponse, Arrays.asList(강남역, 양재역, 광교역));
        ...
        // When 지하철 노선에 등록된 역 목록 조회 요청
        foundLineStationsResponse = LineAcceptanceTest.지하철_노선_조회_요청(신분당선);

        // Then 삭제한 지하철 구간이 반영된 역 목록이 조회됨
        지하철_노선에_지하철역_순서_정렬됨(foundLineStationsResponse, Arrays.asList(강남역, 광교역));
    }
