...
public class LineSectionAcceptanceTest extends AcceptanceTest {
    ...
    @DisplayName("지하철 구간 생성을 실패한다")
    @Test
    void SectionAddFailScenario() {
    ...
    @DisplayName("지하철 구간 제외를 실패한다")
    @Test
    void SectionRemoveFailScenario() {
        // When 지하철 노선에 등록된 지하철역이 두개일 때 한 역을 제외
