...
public class LineSectionAcceptanceTest extends AcceptanceTest {
    ...
    public void setUp() {
        ...
        양재역 = StationAcceptanceTestHelper.지하철역_등록되어_있음("양재역").as(StationResponse.class);
        정자역 = StationAcceptanceTestHelper.지하철역_등록되어_있음("정자역").as(StationResponse.class);
    ...
    void manageLineSection() {
        // when
        ExtractableResponse<Response> createResponse1 = LineSectionAcceptanceTestHelper.지하철_노선에_지하철역_등록_요청(신분당선, 강남역,
            양재역, 2);
        ...
        // when
        ExtractableResponse<Response> createResponse2 = LineSectionAcceptanceTestHelper.지하철_노선에_지하철역_등록_요청(신분당선, 정자역,
            광교역, 5);
