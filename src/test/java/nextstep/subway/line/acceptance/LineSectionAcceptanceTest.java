...
import static nextstep.subway.line.acceptance.LineHelper.*;
...
public class LineSectionAcceptanceTest extends AcceptanceTest {
    ...
    public void setUp() {
        ...
        강남역 = StationHelper.지하철역_등록되어_있음("강남역").as(StationResponse.class);
        양재역 = StationHelper.지하철역_등록되어_있음("양재역").as(StationResponse.class);
        정자역 = StationHelper.지하철역_등록되어_있음("정자역").as(StationResponse.class);
        광교역 = StationHelper.지하철역_등록되어_있음("광교역").as(StationResponse.class);
    ...
    @DisplayName("지하철 노선 구간 관리 통합 테스트")
    @Test
    void 지하철_구간_관리() {

        //when
        ExtractableResponse<Response> createResponse = 지하철_노선에_지하철역_등록_요청(신분당선, 정자역, 광교역, 3);
