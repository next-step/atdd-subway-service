...
public class LineSectionAcceptanceTest extends AcceptanceTest {
    ...
    void addLineSection() {
        // when
        LineSectionTestMethod.지하철_노선에_지하철역_등록_요청(신분당선, 강남역, 양재역, 3);

        // then
        ExtractableResponse<Response> response = LineAcceptanceTest.지하철_노선_조회_요청(신분당선);
		LineSectionTestMethod.지하철_노선에_지하철역_등록됨(response);
		LineSectionTestMethod.지하철_노선에_지하철역_순서_정렬됨(response, Arrays.asList(강남역, 양재역, 광교역));
    }
    ...
    void addLineSection2() {
        // when
		LineSectionTestMethod.지하철_노선에_지하철역_등록_요청(신분당선, 강남역, 양재역, 2);
		LineSectionTestMethod.지하철_노선에_지하철역_등록_요청(신분당선, 정자역, 강남역, 5);

        // then
        ExtractableResponse<Response> response = LineAcceptanceTest.지하철_노선_조회_요청(신분당선);
		LineSectionTestMethod.지하철_노선에_지하철역_등록됨(response);
		LineSectionTestMethod.지하철_노선에_지하철역_순서_정렬됨(response, Arrays.asList(정자역, 강남역, 양재역, 광교역));
    }
    ...
    void removeLineSection1() {
        // given
		LineSectionTestMethod.지하철_노선에_지하철역_등록_요청(신분당선, 강남역, 양재역, 2);
		LineSectionTestMethod.지하철_노선에_지하철역_등록_요청(신분당선, 양재역, 정자역, 2);
        ...
        ExtractableResponse<Response> response = LineAcceptanceTest.지하철_노선_조회_요청(신분당선);
		LineSectionTestMethod.지하철_노선에_지하철역_순서_정렬됨(response, Arrays.asList(강남역, 정자역, 광교역));
    }
