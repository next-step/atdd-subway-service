...
public class LineAcceptanceTest extends AcceptanceTest {
    ...
    public void setUp() {
        ...
        // given
        강남역 = StationAcceptanceTest.지하철역_생성_요청_및_검증("강남역").as(StationResponse.class);
        광교역 = StationAcceptanceTest.지하철역_생성_요청_및_검증("광교역").as(StationResponse.class);

        lineRequest1 = new LineRequest("신분당선", "bg-red-600", 강남역.getId(), 광교역.getId(), 10, 1000);
        lineRequest2 = new LineRequest("구신분당선", "bg-red-600", 강남역.getId(), 광교역.getId(), 15, 2000);
    }
    ...
    void getLine() {
        ...
        // then
        지하철_노선_응답됨(response, lineRequest1);
    }
