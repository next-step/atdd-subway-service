...
public class LineAcceptanceTest extends AcceptanceTest {
    ...
    public void setUp() {
        ...
        lineRequest1 = new LineRequest("신분당선", "bg-red-600", 300, 강남역.getId(), 광교역.getId(), 10);
        lineRequest2 = new LineRequest("구신분당선", "bg-red-600", 400, 강남역.getId(), 광교역.getId(), 15);
    }
    ...
    public static LineResponse 지하철_노선_등록되어_있음(String name, String color, int surcharge, StationResponse upStation,
                                              StationResponse downStation, int distance) {
        return 지하철_노선_생성_요청(
                new LineRequest(name, color, surcharge, upStation.getId(), downStation.getId(), distance)).as(
                LineResponse.class);
    }
