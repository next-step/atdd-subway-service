...
import static nextstep.subway.line.acceptance.LineAcceptanceTestMethod.지하철_노선_목록_포함됨;
import static nextstep.subway.line.acceptance.LineAcceptanceTestMethod.지하철_노선_삭제됨;
import static nextstep.subway.line.acceptance.LineAcceptanceTestMethod.지하철_노선_생성_실패됨;
import static nextstep.subway.line.acceptance.LineAcceptanceTestMethod.지하철_노선_생성_요청;
import static nextstep.subway.line.acceptance.LineAcceptanceTestMethod.지하철_노선_생성됨;
import static nextstep.subway.line.acceptance.LineAcceptanceTestMethod.지하철_노선_수정_요청;
...
public class LineAcceptanceTest extends AcceptanceTest {
    ...
    public void setUp() {
        ...
        lineRequest2 = new LineRequest("구신분당선", "bg-red-600", 강남역.getId(), 광교역.getId(), 15, 900);
    }
