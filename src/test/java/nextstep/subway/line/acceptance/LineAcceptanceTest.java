...
public class LineAcceptanceTest extends AcceptanceTest {
	...
	@Test
	void 시나리오_지하철_노선을_생성하고_등록된_줄_모르고_중복된_노선을_재등록한다() {
		// When: 종로3가역과 신길역의 간격이 100이고 파란색인 1호선을 생성 요청한다.
		ExtractableResponse<Response> 일호선 = 지하철_노선_생성_요청(일호선_요청);
	...
	@Test
	void 시나리오_지하철_2개_노선을_연달아_생성_후_목록을_조회한다() {
		// When: 종로3가역과 신길역의 간격이 100이고 파란색인 1호선을 생성 요청한다.
		ExtractableResponse<Response> 일호선 = 지하철_노선_생성_요청(일호선_요청);
	...
	@Test
	void 시나리오_지하철_노선_생성_후_생성한_노선을_상세_조회한다() {
		// When: 종로3가역과 신길역의 간격이 100이고 파란색인 1호선을 생성 요청한다.
		ExtractableResponse<Response> 일호선 = 지하철_노선_생성_요청(일호선_요청);
	...
	@Test
	void 시나리오_지하철_노선_생성_후_잘못_등록된_노선의_정보를_수정한다() {
		// When: 종로3가역과 신길역의 간격이 100이고 파란색인 1호선을 생성 요청한다.
		ExtractableResponse<Response> 일호선 = 지하철_노선_생성_요청(일호선_요청);
	...
	@Test
	void 시나리오_지하철_노선_중_불필요한_노선을_제거한다() {
		// given: 종로3가역과 신길역의 간격이 100이고 파란색인 1호선이 등록되어 있다.
		// And: 종로3가역과 충무로역의 간격이 300이고 주황색인 3호선이 등록되어 있다.
		ExtractableResponse<Response> 일호선 = 지하철_노선_등록되어_있음(일호선_요청);
		ExtractableResponse<Response> 삼호선 = 지하철_노선_등록되어_있음(삼호선_요청);
