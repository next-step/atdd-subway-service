...
public class LineAcceptanceTest extends AcceptanceTest {
    ...
    public void setUp() {
        ...
        lineRequest2 = new LineRequest("구신분당선", "bg-red-600", 강남역.getId(), 광교역.getId(), 15, 700);
    }
    ...
    public static LineResponse 지하철_노선_등록되어_있음(String lineName, String color, StationResponse upStation, StationResponse downStation, int distance) {
        LineRequest request = new LineRequest(lineName, color, upStation.getId(), downStation.getId(), distance);
    ...
    public static void 지하철_노선_생성됨(ExtractableResponse<Response> response) {
        ...
        assertThat(response.as(LineResponse.class).getSurcharge()).isGreaterThan(0);
    }
