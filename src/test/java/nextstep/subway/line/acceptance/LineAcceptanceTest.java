...
public class LineAcceptanceTest extends AcceptanceTest {
	...
	public static LineResponse 지하철_노선_등록되어_있음(String line, String color, Long upId, Long downId, int distance,
		...
		return 지하철_노선_등록되어_있음(new LineRequest(line, color, upId, downId, distance, fare))
	...
	private static ExtractableResponse<Response> 지하철_노선_목록_조회_요청(ExtractableResponse<Response> response) {
	...
	private static ExtractableResponse<Response> 지하철_노선_제거_요청(ExtractableResponse<Response> response) {
		String uri = response.header("Location");
	...
	private static void 지하철_노선_생성됨(ExtractableResponse response) {
	...
	private static void 지하철_노선_응답됨(ExtractableResponse<Response> response,
		ExtractableResponse<Response> createdResponse) {
		assertThat(response.statusCode()).isEqualTo(HttpStatus.OK.value());
		assertThat(response.as(LineResponse.class)).isNotNull();
	}

	private static void 지하철_노선_목록_포함됨(ExtractableResponse<Response> response,
