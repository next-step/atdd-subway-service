...
public class LineAcceptanceTest extends AcceptanceTest {
    ...
    public void setUp() {
        ...
        lineRequest3 = new LineRequest("추가요금신분당선", "bg-red-600", 강남역.getId(), 광교역.getId(), 15, 1200);
    }
    ...
    void createLineWithOverFare() {
        ...
        // then
        지하철_노선_생성됨(response);
        지하철_노선_추가요금저장됨(response, lineRequest3.getOverFare());
    }
    ...
    private void 지하철_노선_추가요금저장됨(ExtractableResponse<Response> response, int expectedOverFare) {
        assertThat((int) response.jsonPath().get("overFare")).isEqualTo(expectedOverFare);
    }
}
