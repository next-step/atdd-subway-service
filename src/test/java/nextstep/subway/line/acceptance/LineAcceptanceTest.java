...
public class LineAcceptanceTest extends AcceptanceTest {
    ...
    @DisplayName("추가요금 지하철 노선을 추가한다.")
    @Test
    void surcharge_addLine() {
        // when
        ExtractableResponse<Response> response = 지하철_노선_생성_요청(lineRequest1);
        ...
        // and
        지하철_추가_요금_등록됨(response);
    }

    private void 지하철_추가_요금_등록됨(ExtractableResponse<Response> response) {
        assertThat(response.as(LineResponse.class).getSurcharge()).isEqualTo(900);
    }
