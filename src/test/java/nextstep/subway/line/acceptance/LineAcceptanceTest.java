...
public class LineAcceptanceTest extends AcceptanceTest {
    ...
    public static LineResponse 지하철_노선_등록되어_있음(String name, String color, StationResponse upStation, StationResponse downStation, int distance, int addPrice) {
        LineRequest lineRequest = new LineRequest(name, color, upStation.getId(), downStation.getId(), distance, addPrice);
        return 지하철_노선_등록되어_있음(lineRequest).as(LineResponse.class);
    }
