...
public class LineAcceptanceTest extends AcceptanceTest {
    ...
    public void setUp() {
        ...
        lineCreateRequest1 = new LineCreateRequest("신분당선", "bg-red-600", 강남역.getId(), 광교역.getId(), 10);
        lineCreateRequest2 = new LineCreateRequest("구신분당선", "bg-red-600", 강남역.getId(), 광교역.getId(), 15);
    }
    ...
    void createLine() {
        // when
        ExtractableResponse<Response> response = 지하철_노선_생성_요청(lineCreateRequest1);
    ...
    void createLineWithDuplicateName() {
        // given
        지하철_노선_등록되어_있음(lineCreateRequest1);
    ...
    void getLines() {
        // given
        ExtractableResponse<Response> createResponse1 = 지하철_노선_등록되어_있음(lineCreateRequest1);
        ExtractableResponse<Response> createResponse2 = 지하철_노선_등록되어_있음(lineCreateRequest2);
    ...
    void getLine() {
        // given
        ExtractableResponse<Response> createResponse = 지하철_노선_등록되어_있음(lineCreateRequest1);
    ...
    void updateLine() {
        ...
        // when
        ExtractableResponse<Response> response = 지하철_노선_수정_요청(createResponse, lineCreateRequest2);
    ...
    public static ExtractableResponse<Response> 지하철_노선_등록되어_있음(LineCreateRequest params) {
    ...
    public static ExtractableResponse<Response> 지하철_노선_수정_요청(ExtractableResponse<Response> response, LineCreateRequest params) {
        String uri = response.header("Location");
