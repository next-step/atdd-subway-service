...
import static nextstep.subway.line.acceptance.LineRestAssured.지하철_노선_목록_조회_요청;
...
public class LineAcceptanceTest extends AcceptanceTest {
    ...
    void updateLine() {
        // given
        String newName = "구신분당선";
        ExtractableResponse<Response> createResponse = 지하철_노선_등록되어_있음(lineRequest1);
        LineRequest modifyLineRequest = new LineRequest(newName, "bg-red-600", 강남역.getId(), 광교역.getId(), 15);

        // when
        ExtractableResponse<Response> response = 지하철_노선_수정_요청(createResponse, modifyLineRequest);
