package nextstep.subway.line.rest;
...
public class LineRestAssured {
    ...
    public static ExtractableResponse<Response> 지하철_노선_수정_요청(ExtractableResponse<Response> response, LineUpdateRequest params) {
        String uri = response.header("Location");
