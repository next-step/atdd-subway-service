...
class ConnectionTypeTest {
    ...
    void 현재_구간의_상행역과_요청_구간의_하행역이_같으면_상행_종점역() {
        Section current = new Section(강남역, 역삼역, 10);
        Section request = new Section(교대역, 강남역, 10);
    ...
    void 현재_구간의_상행역과_요청_구간의_상행역이_같으면_역_사이() {
        Section current = new Section(강남역, 선릉역, 10);
        Section request = new Section(강남역, 역삼역, 10);
    ...
    void 현재_구간의_하행역과_요청_구간의_하행역이_같으면_역_사이() {
        Section current = new Section(강남역, 선릉역, 10);
        Section request = new Section(역삼역, 선릉역, 10);
