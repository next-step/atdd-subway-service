...
import static nextstep.subway.station.domain.StationFixture.오이도역;
...
import static nextstep.subway.station.domain.StationFixture.충무로역;
import static nextstep.subway.station.domain.StationFixture.합정역;
...
public class SectionFixture {
    ...
    public static Section 일호선_구간_중간추가_신용산역_서울역() {
        return new Section(6L, 일호선(), 신용산역(), 서울역(), 2);
    }
    ...
    public static Section 삼호선_구간_안국역_종로3가역() {
        return new Section(11L, 삼호선(), 안국역(), 종로3가역(), 2);
    }

    public static Section 삼호선_구간_종로3가역_을지로3가역() {
        return new Section(12L, 삼호선(), 종로3가역(), 을지로3가역(), 2);
    }

    public static Section 삼호선_구간_을지로3가역_충무로역() {
        return new Section(13L, 삼호선(), 을지로3가역(), 충무로역(), 1);
    }

    public static Section 삼호선_일호선_연결_안국역_강남역() {
        return new Section(14L, 삼호선(), 강남역(), 안국역(), 4);
    }

    public static Section 삼호선_일호선_연결_충무로역_역삼역() {
        return new Section(15L, 삼호선(), 충무로역(), 역삼역(), 4);
    }

    public static Section 사호선_구간_사당역_오이도역() {
        return new Section(16L, 사호선(), 사당역(), 오이도역(), 4);
    }
