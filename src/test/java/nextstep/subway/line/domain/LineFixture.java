...
public class LineFixture {
	public static Line 신분당선_강남역_광교역() {
		List<Section> sections = Collections.singletonList(SectionFixture.강남역_광교역_구간());

		return Line.of(1L, "신분당선", "red lighten-1", 900, sections);
	}
	...
	public static Line 신분당선() {
		...
		return Line.of(2L, "신분당선", "bg-red-600", 900, sections);
	}
	...
	public static Line 이호선() {
		...
		return Line.of(3L, "2호선", "bg-green-600", 500, sections);
	}
	...
	public static Line 삼호선() {
		...
		return Line.of(4L, "3호선", "bg-orange-600", 0, sections);
	}

	public static Line 사호선() {
		List<Section> sections = Arrays.asList(SectionFixture.중앙역_한대앞역_구간());

		return Line.of(5L, "4호선", "bg-blue-600", 0, sections);
	}
}
