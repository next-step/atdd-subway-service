...
class DiscountTest {
    ...
    @CsvSource({
            ...
            "19, ADULT",
            "1000, ADULT"})
    void of(int age, AgeDiscountType discount) {
        assertThat(AgeDiscountType.of(age)).isEqualTo(discount);
    }
    ...
    @CsvSource({
            ...
            "ADULT, 2000, 2000",
            "ADULT, 2000, 2000"})
    void calculate(AgeDiscountType discount, int fare, int expected) {
