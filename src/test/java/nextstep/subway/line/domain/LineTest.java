...
class LineTest {
    ...
    public void addSectionTest1() {
        ...
        assertThatThrownBy(() -> line.addSection(강남, 양재, 10))
    ...
    public void addSectionTest2() {
        ...
        assertThatThrownBy(() -> line.addSection(판교, 신논현, 10))
                .isInstanceOf(RuntimeException.class);
    }
