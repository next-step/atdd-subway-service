...
class LineTest {
    ...
    void 노선에_포함된_역_조회() {
        ...
        line.addSection(구로역, 신도림역, new Distance(10));
        line.addSection(신도림역, 영등포역, new Distance(10));
        line.addSection(영등포역, 신길역, new Distance(10));
    ...
    void 구간_추가() {
        Line line = new Line("1호선", "dark-blue");
        Section section = new Section(line, new Station("상행종점역"), new Station("하행종점역"), 거리_10);
    ...
    void 역_삭제() {
        Line line = new Line("1호선", "dark-blue");
        line.addSection(구로역, 신도림역, 거리_10);
        line.addSection(신도림역, 영등포역, 거리_10);
        line.addSection(영등포역, 신길역, 거리_10);
