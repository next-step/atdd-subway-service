...
public class FavoriteAcceptanceTest extends AcceptanceTest {
    ...
    void manageFavorite() {
        //when
        ExtractableResponse<Response> createResponse = FavoriteFixture.즐겨찾기_생성(accessToken, 강남역.getId(),
            정자역.getId());
        //then
        즐겨찾기_생성됨(createResponse);

        //when
        List<FavoriteResponse> getFavoriteResponses = FavoriteFixture.즐겨찾기_목록_조회(accessToken).jsonPath()
            .getList(".", FavoriteResponse.class);
        //then
        즐겨찾기_목록_조회됨(getFavoriteResponses);

        //when
        ExtractableResponse<Response> deleteResponse = FavoriteFixture.즐겨찾기_삭제_요청(accessToken,
    ...
    void delete_others_favorite() {
        ...
        //when
        ExtractableResponse<Response> deleteResponse = FavoriteFixture.즐겨찾기_삭제_요청(newAccessToken,
            getURI(createResponse));
        //then
