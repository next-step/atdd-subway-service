...
public class TestLineFactory {
    ...
    public static final LineRequest LINE_REQUEST = LineRequest.of("신분당선", "bg-red-600", 1L, 2L, 10, new BigDecimal(900));
    public static final LineRequest ANOTHER_LINE_REQUEST = LineRequest.of("bg-red-600", "2호선", 3L, 4L, 10, new BigDecimal(900));
