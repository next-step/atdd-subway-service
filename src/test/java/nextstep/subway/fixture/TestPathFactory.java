...
public class TestPathFactory {
    public static ExtractableResponse<Response> 지하철_최적_경로_요청(final Long source, final Long target) {
    ...
    public static void 지하철_최적_경로_목록_포함됨(ExtractableResponse<Response> response, int 개수, double 거리, StationResponse... 역) {
