...
public class StationAcceptanceTest extends AcceptanceTest {
    ...
    void createStationWithDuplicateName() {
        //given
        StationRestAssured.지하철역_등록되어_있음(강남역);
    ...
    void getStations() {
        // given
        ExtractableResponse<Response> createResponse1 = StationRestAssured.지하철역_등록되어_있음(강남역);
        ExtractableResponse<Response> createResponse2 = StationRestAssured.지하철역_등록되어_있음(역삼역);
    ...
    void deleteStation() {
        // given
        ExtractableResponse<Response> createResponse = StationRestAssured.지하철역_등록되어_있음(강남역);

        // when
        ExtractableResponse<Response> response = StationRestAssured.지하철역_제거_요청(createResponse);
