...
public class StationAcceptanceTest extends BaseTest {
	...
	void getStations() {
		// given
		StationResponse createResponse1 = 지하철역_등록되어_있음(강남역).as(StationResponse.class);
		StationResponse createResponse2 = 지하철역_등록되어_있음(역삼역).as(StationResponse.class);
	...
	public static void 지하철역_목록_포함됨(ExtractableResponse<Response> response, List<StationResponse> expectedStations) {
		...
		assertThat(resultLineIds).containsExactlyElementsOf(expectedStationIds);
	}
}
