...
class AgeFarePolicyTest {
    ...
    void old_age_test(int param) {
        AgePolicy agePolicy = AgeFareType.getAgePolicy(param);

        assertThat(agePolicy.calculate()).isEqualTo(0);
    }
    ...
    void adult_age_test(int param) {
        ...
        assertThat(agePolicy.calculate()).isEqualTo(1250);
    }
    ...
    void teenager_age_test(int param) {
        ...
        assertThat(agePolicy.calculate()).isEqualTo(720);
    }
    ...
    void child_age_test(int param) {
        ...
        assertThat(agePolicy.calculate()).isEqualTo(450);
    }
    ...
    void age_exception_test(int param) {
        assertThatThrownBy(() -> {
            AgeFareType.getAgePolicy(param);
