...
class FareTest {
    ...
    void less_than_10km() {
        ...
        // when
        Fare fare = Fare.of(path, AgeType.getDiscountPolicy(익명사용자));
    ...
    void greater_than_50km() {
        ...
        // then
        assertThat(fare.get()).isEqualTo(1850);
    }
    ...
    void basic_fare() {
        ...
        // when
        Fare fare = Fare.of(path, AgeType.getDiscountPolicy(일반회원));
    ...
    void teenagers_fare() {
        ...
        // when
        Fare fare = Fare.of(path, AgeType.getDiscountPolicy(청소년회원));
    ...
    void kids_fare() {
        ...
        // when
        Fare fare = Fare.of(path, AgeType.getDiscountPolicy(어린이회원));
