...
public class FareTest {
    ...
    public void 초과금액_50km_이내() {
        ...
        assertEquals(defaultFare.getValue(), 1950);
    }
    ...
    public void 초과금액_50km_초과() {
        ...
        assertEquals(defaultFare.getValue(), 2350);
    }
    ...
    public void 어린이_할인() {
        ...
        assertEquals(defaultFare.getValue(), 1000);
    }
    ...
    public void 청소년_할인() {
        ...
        assertEquals(defaultFare.getValue(), 1600);
    }
