...
public class PathFinderTest {
    ...
    public void setUp() {
        ...
        신분당선 = new Line("신분당선", "빨간색", 강남역, 양재역, 10, 500);
        이호선 = new Line("이호선", "빨간색", 교대역, 강남역, 10,200);
        삼호선 = new Line("삼호선", "빨간색", 교대역, 양재역, 5, 0);
        이어지지않는호선 = new Line("이어지지않는호선", "빨간색", 이어지지않는역_1, 이어지지않는역_2, 5, 0);
