...
class PathAcceptanceTest extends AcceptanceTest {
	...
	public void setUp() {
		...
		이호선 = PathAcceptanceSupport.지하철_노선_등록되어_있음("이호선", "bg-red-600", 교대역, 강남역, 10);
	...
	@Test
	void requestPath() {
		ExtractableResponse<Response> response = PathAcceptanceSupport.지하철_경로_조회_요청(강남역, 남부터미널역);

		PathAcceptanceSupport.지하철_경로_조회됨(response);
	}
}
