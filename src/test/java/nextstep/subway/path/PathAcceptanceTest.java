...
class PathAcceptanceTest extends AcceptanceTest {
    ...
    void setUp() {
        ...
        신분당선 = 지하철_노선_등록되어_있음(new LineCreateRequest("신분당선", "bg-red-600",
            new SectionRequest(강남역.getId(), 양재역.getId(), 10)));
        이호선 = 지하철_노선_등록되어_있음(new LineCreateRequest("이호선", "bg-red-600",
            new SectionRequest(교대역.getId(), 강남역.getId(), 10)));

        삼호선 = 지하철_노선_등록되어_있음(new LineCreateRequest("삼호선", "bg-red-600",
