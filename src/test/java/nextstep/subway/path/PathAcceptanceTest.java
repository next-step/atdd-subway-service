...
public class PathAcceptanceTest extends AcceptanceTest {
    ...
    public void setUp() {
        ...
        일호선 = 지하철_노선_등록되어_있음("일호선", "bg-blue-600", 노량진역, 대방역, 7);
        구호선 = 지하철_노선_등록되어_있음("구호선", "bg-yellow-600", 노량진역, 샛강역, 5);
        오호선 = 지하철_노선_등록되어_있음("오호선", "bg-purple-600", 신길역, 여의도역, 10);

        지하철_노선에_지하철역_등록_요청(일호선, 노량진역, 신길역, 10);
        지하철_노선에_지하철역_등록_요청(구호선, 샛강역, 여의도역, 8);
        지하철_노선에_지하철역_등록_요청(오호선, 신길역, 여의나루역, 12);
    }
}
