...
class PathAcceptanceTest extends AcceptanceTest {
    ...
    Stream<DynamicTest> findPaths_성공() {
        return Stream.of(
                ...
                dynamicTest("경로를 조회하고 확인한다.(0회 환승 / 출발역: 영등포구청역, 도착역: 신길역)", 경로_조회_요청_및_성공_확인(authToken, 영등포구청역, 신길역, asList(영등포구청역, 영등포시장역, 신길역), 15, 1200)),
                dynamicTest("경로를 조회하고 확인한다.(1회 환승 / 출발역: 당산역, 도착역: 양평역)", 경로_조회_요청_및_성공_확인(authToken, 당산역, 양평역, asList(당산역, 영등포구청역, 양평역), 20, 1250)),
                dynamicTest("경로를 조회하고 확인한다.(2회 환승 / 출발역: 영등포역, 도착역: 당산역)", 경로_조회_요청_및_성공_확인(authToken, 영등포역, 당산역, asList(영등포역, 신길역, 영등포시장역, 영등포구청역, 당산역), 30, 1350))
        );
    }
