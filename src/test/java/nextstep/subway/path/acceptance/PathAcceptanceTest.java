...
public class PathAcceptanceTest extends AcceptanceTest {
    ...
    void 예외_출발역과_도착역이_같음() {
        // when
        ExtractableResponse<Response> response = 최단_경로_조회(강남역.getId(), 강남역.getId(), accessToken);
    ...
    void 예외_출발역과_도착역_미연결() {
        // when
        ExtractableResponse<Response> response = 최단_경로_조회(강남역.getId(), 광교역.getId(), accessToken);
    ...
    void 예외_존재하지_않는_출발역_또는_도착역() {
        // when
        ExtractableResponse<Response> response = 최단_경로_조회(Long.MAX_VALUE-1, Long.MAX_VALUE-2, accessToken);
