...
import static nextstep.subway.path.acceptance.PathAcceptanceTestUtils.지하철_경로_조회_실패됨;
import static nextstep.subway.path.acceptance.PathAcceptanceTestUtils.지하철_경로_조회_요청;
import static nextstep.subway.path.acceptance.PathAcceptanceTestUtils.지하철_경로_조회됨;
...
class PathAcceptanceTest extends AcceptanceTest {
    ...
    public void setUp() {
        ...
        지하철_노선_등록되어_있음(이호선_요청).as(LineResponse.class);
