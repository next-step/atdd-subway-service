...
class PathFinderTest {
    ...
    public void findShortestPath() {
        // When
        PathFinder pathFinder = PathFinder.from(전체_노선);
        ShortestPathResponse 최단_경로_응답 = pathFinder.findShortestPath(선정릉역, 양재역);
    ...
    public void throwException_WhenSourceIsEqualToTarget() {
        ...
        assertThatExceptionOfType(IllegalArgumentException.class)
            .isThrownBy(() -> pathFinder.findShortestPath(선정릉역, 선정릉역));
    }
    ...
    public void throwException_WhenSourceAndTargetIsNotContainsInLines() {
        ...
        // When & Then
        assertThatExceptionOfType(IllegalArgumentException.class)
            .isThrownBy(() -> pathFinder.findShortestPath(선정릉역, 천호역));
    }
