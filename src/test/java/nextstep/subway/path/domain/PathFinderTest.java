...
class PathFinderTest {
	...
	public void findPath_happyPath() {
		Optional<Path> path = PathFinder.findPath(sections, 교대역, 양재역);
	...
	public void findPath_exceptionCase1() {
		Optional<Path> path = PathFinder.findPath(sections, 교대역, 석촌역);
	...
	public void findPath_exceptionCase2() {
		Optional<Path> path = PathFinder.findPath(sections, 교대역, 잠실역);
