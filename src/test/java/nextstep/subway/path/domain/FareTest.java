...
class FareTest {
    ...
    void 나이대별_요금을_구할_수_있다(int age, int expectedFare) {
        Fare fare = new Fare(new Distance(10), new Age(age), new ExtraFare(0));
    ...
    void 나이대별_추가요금이_제대로_더해질_수_있다(int age, int expectedFare) {
        Fare fare = new Fare(new Distance(10), new Age(age), new ExtraFare(1000));
        assertThat(fare.getFare()).isEqualTo(expectedFare);
    }
    ...
    void 거리별_요금을_구할_수_있다(int distance, int expectedFare) {
        Fare fare = new Fare(new Distance(distance), new Age(19), new ExtraFare(0));
        assertThat(fare.getFare()).isEqualTo(expectedFare);
    }
