...
public class FareTest {
    ...
    void getMaxSurchargeByLine() {
        ...
        Line 삼호선 = new Line("삼호선", "ORANGE", 교대역, 양재역, 2);
        Line 이호선 = new Line("이호선", "ORANGE", 강남역, 양재역, 2, 600);
        Line 신분당선 = new Line("신분당선", "RED", 양재역, 판교역, 2, 900);

        List<Section> sections = Arrays.asList(new Section(삼호선, 교대역, 강남역, 2),
