...
import nextstep.subway.path.domain.fee.distanceFee.SuperLongFee;
...
class SuperLongFeeTest {
    ...
    void createFailTest(Integer tooShortDistance) {
        assertThatThrownBy(() -> new SuperLongFee(tooShortDistance))
    ...
    void calculateTest(Integer distance, Integer expectedFee) {
        ...
        assertThat(fee.calculate()).isEqualTo(BigDecimal.valueOf(expectedFee));
    }
}