...
class PathServiceTest {
    ...
    public void setUp() {
        ...
        신분당선 = new Line("신분당선", "bg-red-600", 강남역, 양재역, Distance.of(10));
        이호선 = new Line("이호선", "bg-green-600", 교대역, 강남역, Distance.of(10));
        삼호선 = new Line("삼호선", "bg-orange-600", 교대역, 양재역, Distance.of(5));
