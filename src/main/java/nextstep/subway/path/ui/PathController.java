...
public class PathController {
    ...
    public ResponseEntity<PathFinderResponse> findShortestPath(@AuthenticationPrincipal LoginMember loginMember,
        ...
        final FarePolicyByPassenger farePolicyByPassenger = FarePolicyByPassenger.getPassengerType(loginMember.getAge());
        return ResponseEntity.ok(pathService.findShortestPath(farePolicyByPassenger, source, target));
    }
}
