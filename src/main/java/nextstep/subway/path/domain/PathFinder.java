...
public class PathFinder {
    ...
    private void addStations(WeightedMultigraph<Station, DefaultWeightedEdge> graph, List<Line> lines) {
        lines.stream()
    ...
    private void addDistance(WeightedMultigraph<Station, DefaultWeightedEdge> graph, List<Line> lines) {
        lines.stream()
             ...
             .forEach(section -> {
                 ...
                 graph.setEdgeWeight(weightedEdge, section.getDistanceValue());
             });
    }
