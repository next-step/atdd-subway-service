...
public class DistanceFarePolicy {
    ...
    private Fare getExtraFareEvery5KM(Distance distance) {
        ...
        return Fare.of((int) ((Math.ceil((extraDistance.getDistance() - 1) / 5) + 1) * EXTRA_FARE.getFare()));
    }
    ...
    private Fare getExtraFareEvery8KM(Distance distance) {
        ...
        return Fare.of(extraFare5KM.getFare() + (int) ((Math.ceil((extraDistance.getDistance() - 1) / 8) + 1) * EXTRA_FARE.getFare()));
    }
}
