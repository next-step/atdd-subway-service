...
public class DataLoaderConfig implements CommandLineRunner {
    ...
    public DataLoaderConfig(LineRepository lineRepository,
    ...
    public void run(String... args) throws Exception {
        ...
        stationRepository.saveAll(Lists.newArrayList(강남역, 교대역, 양재역, 남부터미널역));

        Line 신분당선 = new Line("신분당선", "red lighten-1", 900, 강남역, 양재역, 10);
