...
public class DataLoaderConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Line 신분당선 = new Line("신분당선", "red lighten-1", 강남역, 양재역, new Distance(10), new Fare(900));
        Line 이호선 = new Line("2호선", "green lighten-1", 교대역, 강남역, new Distance(10), new Fare(900));
        Line 삼호선 = new Line("3호선", "orange darken-1", 교대역, 양재역, new Distance(10), new Fare(900));
