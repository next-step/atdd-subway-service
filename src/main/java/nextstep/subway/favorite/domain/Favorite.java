...
import static nextstep.subway.exception.ErrorMessage.FAVORITE_SOURCE_TARGET_STATION_CANNOT_SAME;
...
public class Favorite extends BaseEntity {
    ...
    private void validateFavorite(Station sourceStation, Station targetStation) {
        if (sourceStation.equals(targetStation)) {
            throw new IllegalArgumentException(FAVORITE_SOURCE_TARGET_STATION_CANNOT_SAME.getMessage());
        }
    }
