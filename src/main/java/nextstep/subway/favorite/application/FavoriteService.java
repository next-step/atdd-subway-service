...
public class FavoriteService {
    ...
    public FavoriteResponse saveFavorite(@AuthenticationPrincipal LoginMember loginMember, FavoriteRequest request) {
        ...
        Section section = sectionRepository.findByUpStationAndDownStation(source, target).orElseThrow(() -> new IllegalArgumentException("해당 노선을 찾을 수 없습니다."));
