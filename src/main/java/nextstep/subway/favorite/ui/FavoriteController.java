...
public class FavoriteController {
    ...
    @PostMapping
    public ResponseEntity<FavoriteResponse> create(@AuthenticationPrincipal LoginMember loginMember, @RequestBody
    ...
    public ResponseEntity<List<FavoriteResponse>> findAll(@AuthenticationPrincipal LoginMember loginMember){
        ...
        List<FavoriteResponse> favoriteResponses= favoriteService.findAll(loginMember.getId());
    ...
    public ResponseEntity delete(@AuthenticationPrincipal LoginMember loginMember, @PathVariable Long id){
        favoriteService.remove(loginMember.getId(), id);
