...
public class LineRequest {
    ...
    public static LineRequest from(String name, String color, Long upStationId, Long downStationId, int distance){
    ...
    public Line toUpdateLineInfo(){
        return Line.ofNameAndColor(name, color);
    }
}
