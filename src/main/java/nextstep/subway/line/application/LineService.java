...
public class LineService {
    ...
    public LineResponse saveLine(LineRequest request) {
        ...
        Line savedLine = lineRepository.save(
            new Line(request.getName(), request.getColor(), upStation, downStation,
                request.getDistance()));
        return LineResponse.of(savedLine, savedLine.getStations());
    }
    ...
    public LineResponse findLineResponseById(Long id) {
        ...
        List<Station> stations = findLine.getStations();
    ...
    public void addLineStation(Long lineId, SectionRequest request) {
        ...
        line.addLineSection(new Section(line,upStation, downStation, request.getDistance()));
    }
