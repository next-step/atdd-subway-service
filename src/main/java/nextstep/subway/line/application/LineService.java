...
public class LineService {
  ...
  public LineResponse saveLine(LineRequest request) {
    ...
    return LineResponse.of(persistLine, StationResponse.ofList(stations));
  }
  ...
  public List<LineResponse> findLines() {
    ...
    return persistLines.stream()
        .map(line -> {
          List<StationResponse> stations = StationResponse.ofList(line.getStations());
  ...
  public LineResponse findLineResponseById(Long id) {
    ...
    List<StationResponse> stations = StationResponse.ofList(persistLine.getStations());
