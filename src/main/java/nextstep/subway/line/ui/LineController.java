...
import nextstep.subway.sections.application.SectionService;
...
public class LineController {
    ...
    public ResponseEntity addLineStation(@PathVariable Long lineId,
        ...
        sectionService.addLineStation(lineId, sectionRequest);
        return ResponseEntity.ok().build();
    }
    ...
    public ResponseEntity removeLineStation(@PathVariable Long lineId,
        ...
        sectionService.removeLineStation(lineId, stationId);
        return ResponseEntity.ok().build();
    }
