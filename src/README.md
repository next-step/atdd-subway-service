...
* 기본운임(10km 이내): 기본운임 1,250원
    * 노선별 추가 요금이 존재하며, 여러 노선을 환승하여 이용한다면 가장 큰 추가요금만 기본운임에 추가하여 계산한다
* 이용 거리초과 시 추가운임 부과
    * 10km 초과 ~ 50km 시 5km 마다 100원
    * 50km 초과 시 8km 마다 100원
* 로그인 사용자의 연령별 요금 할인 적용
    * 청소년(13 세 ~ 19 세 미만) 이 이용한 경우 운임에서 350 원을 공제한 결과에 20% 할인
    * 어린이(6 세 ~ 13 세 미만) 이 이용한 경우 운임에서 350 원을 공제한 결과에 50% 할인
