...
- [x] 노선에 따른 요금정책이 부여된다.
  - [x] 경로에 있는 노선중 가장 높은 금액만 적용된다.
- [x] 연령별 요금할인이 적용된다.
  - [x] 연령이 6이상 ~ 13미만은 총 운임에서 350원을 제외한 금액의 50%을 할인된다.
  - [x] 연령이 13이상 ~ 19미만은 총 운임에서 350원을 제외한 금액의 20%을 할인된다.
- [x] 계산된 요금이 FrontEnd의 경로탐색에 조회된다.