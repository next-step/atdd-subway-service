...
### 기능 목록
- [ ] 거리별 요금 정책 Enum 작성
- [ ] 연령별 요금 할인 정책 Enum 작성
- [ ] Line 추가 요금 필드 추가
- [ ] PathResponse 총 거리 응답 필드 추가
- [ ] PathResponse 이용 요금 응답 필드 추가
- [ ] PathServiceTest 총 거리 응답 확인 테스트 추가
- [ ] PathServiceTest 이용 요금 응답 확인 테스트 추가
- [ ] PathFinder 총 거리 도메인 테스트 추가 및 구현
- [ ] PathFinder 총 거리 도메인 테스트 추가
- [ ] 요금 도메인 테스트 작성 및 구현
