...
- [X] 로그인 사용자의 경우 연령별 요금 할인(MemberDiscount)을 적용하는 도메인 서비스 구현
    - [X] 어린이의 경우 운임에서 350원을 공제한 금액의 50% 할인한다. (6세 이상~ 13세 미만)
    - [X] 청소년의 경우 운임에서 350원을 공제한 금액의 20% 할인한다. (13세 이상~19세 미만)
    - [X] 청소년이나 어린이가 아니면 할인금액을 제공하지 않는다.
